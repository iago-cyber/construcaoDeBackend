...
describe('Teste da API /produtos', function () {
    ...
    test('POST / deve retornar 422 e um objeto JSON', async function () {
        ...
        expect(response.type).toBe('application/json');
        expect(response.body).toHaveProperty('msg', "Nome e preço são obrigatorios");
    ...
    test('PUT /1 deve retornar 422 e um objeto JSON', async function () {
